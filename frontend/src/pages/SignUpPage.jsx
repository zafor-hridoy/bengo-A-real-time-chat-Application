            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30 relative">
              <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8 animate-fade-in">
                  ...
                  <p className="text-slate-400 animate-fade-in-delay">Join the future of messaging</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="animate-slide-in-left" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div className="relative group">
                      <UserIcon className={`auth-input-icon transition-all duration-300 ${focusedInput === 'fullName' ? 'text-cyan-400 scale-110' : ''}`} />
                      <input
                        type="text"
                  ...
                  <div className="animate-slide-in-left" style={{ animationDelay: '0.3s' }}>
                    <label className="auth-input-label flex items-center gap-2">
                      <span>Password</span>
                      <span className="text-cyan-400 text-xs opacity-0 animate-fade-in" style={{ animationDelay: '0.5s' }}></span>
                    </label>
                    <div className="relative group">
                ...
                <div className="mt-6 text-center animate-fade-in-delay" style={{ animationDelay: '0.6s' }}>
                  <Link to="/login" className="auth-link-modern group">
                    <span>Already have an account?</span>
                    <span className="ml-1 text-cyan-400 group-hover:translate-x-1 inline-block transition-transform">Login →</span>
                  </Link>
                </div>
              </div>
            </div>
            ...
            <div className="hidden md:w-1/2 md:flex items-center justify-center p-6 bg-gradient-to-bl from-slate-800/20 to-transparent relative">
              <div className="animate-fade-in-scale">
                <div className="relative">
                  <img
                    src="/Signup.png"
                    alt="Two lovie dovie people chatting"
                ...
                <div className="mt-6 text-center">
                  ...
                  <div className="mt-8 space-y-3 text-left max-w-sm mx-auto">
                    <div className="flex items-center gap-3 text-slate-300 animate-slide-in-right" style={{ animationDelay: '0.5s' }}>
                      ...
                      <span className="text-sm">End-to-end encrypted messages</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3 text-slate-300 animate-slide-in-right" style={{ animationDelay: '0.7s' }}>
                      <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse" />
                      <span className="text-sm">Seamless media sharing</span>
                    </div>
                  </div>
                </div>
              </div>
